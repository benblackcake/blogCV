...
class BlogPost(models.Model):
    ...
    post_title = models.CharField(name='post_title',max_length=30)
    post_context = models.CharField(name='post_context',max_length=10000)
    post_date = models.DateField(default=None,name='post_date')
    class Meta:
        managed = False
        db_table = 'blog_post'
